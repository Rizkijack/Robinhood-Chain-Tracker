...
export function TokenDetailModal({
  ...
  const [activeTab, setActiveTab] = useState<
    "chart" | "pools" | "swap" | "links" | "transactions"
  >("chart");
  ...
  // Transaction stream hook — pass pairAddress + price for Blockscout USD values
  const {
    transactions,
    isLoading: txLoading,
    error: txError,
    ...
    setFilter,
    refetch,
  } = useTokenTransactions(address, pair.pairAddress, pair.priceUsd, pair.symbol);
